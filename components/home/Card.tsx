...
const Card = ({ story }) => {
  ...
  return (
    <Link href={`/stories/${story.id}`} className="block">
      <div className="w-[300px] bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-100 transform hover:-translate-y-1 transition-transform duration-300">
        {/* 상단 이미지 영역 */}
